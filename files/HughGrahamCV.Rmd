...
I predominantly use R and Python for data analysis and software development. However, I would jump at any opportunity to learn new languages. Access to new problems and continuous learning are the aspects of software development that I enjoy the most.
...
* Much of the SFM work that we do is computationally intensive and I have therefore helped to move some of this processing to Exeter University's ISCA HPC facility as part of [Cunliffe, et al.](http://biorxiv.org/lookup/doi/10.1101/2020.07.16.206011). This has been a really exciting project and I would enjoy the opportunity to further improve and develop my skills with HPC.
...
Beyond work, I enjoy getting outdoors whenever possible, in particular I like to make the most of thw South West's beaches and rivers by going spearfishing and kayaking.
